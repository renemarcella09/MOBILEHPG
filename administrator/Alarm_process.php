		...
		while($row=mysqli_fetch_assoc($result)){
			...
			<tr>
				...
				<td width="1%" style="white-space:nowrap;">
					<a href="" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-<?php echo $row["Vinid"];?>"><i class="fa fa-edit" ></i> </a>
					...
					<button class="btn btn-sm btn-danger" onclick="deleteData(<?php echo $row["Vinid"];?>)"><i class="fa fa-trash" ></i> </button>
				</td>
			</tr>
			<?php
		}
